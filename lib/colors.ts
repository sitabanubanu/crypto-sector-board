...
export function getSectorReturn(sector: SectorSnapshot, period: PeriodType): number | null {
...
export function getCoinReturn(coin: CoinSnapshot, period: PeriodType): number | null {
...
export function hasSectorReturnForPeriod(sector: SectorSnapshot, period: PeriodType): boolean {
  const coverage = sector.coverageByPeriod?.[period];
  return getSectorReturn(sector, period) != null && (coverage == null || coverage >= 0.8);
}
...
export function hasCoinReturnForPeriod(coin: CoinSnapshot, period: PeriodType): boolean {
  return getCoinReturn(coin, period) != null;
}
